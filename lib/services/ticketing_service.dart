...
class TicketingService {
  ...
  static Future<TiketPesanan> buatPesanan({
    ...
    try {
      CrashlyticsService.log('buatPesanan: $judulPertunjukan | total: $totalHarga');
      await ref.set(pesanan.toMap());
    } catch (e, stack) {
      await CrashlyticsService.logError(e, stack, reason: 'Gagal membuat pesanan: $judulPertunjukan');
      rethrow;
    }
    return pesanan;
  }
  ...
  static Future<void> batalkanPesanan(String pesananId) async {
    try {
      CrashlyticsService.log('batalkanPesanan: $pesananId');
      ...
      await CrashlyticsService.logError(e, stack, reason: 'Gagal membatalkan pesanan: $pesananId');
      rethrow;
    }
  }
}